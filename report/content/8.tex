...
\begin{itemize}
    \item \textbf{Apple Silicon:} Utilizando el framework \textbf{MLX} para maximizar el uso de la memoria unificada. Se ha implementado un sistema de \textbf{Gestión Dinámica de Caché de Metal} que reserva automáticamente un margen de seguridad de \textbf{6GB} para el sistema operativo y libera la caché de forma agresiva mediante \texttt{mx.clear\_cache()} tras cada experimento.
