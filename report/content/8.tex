...
Como valor añadido a la implementación técnica, se ha diseñado una arquitectura \textbf{Hardware Agnostic} que garantiza la portabilidad del proyecto entre diferentes entornos de computación de alto rendimiento.
