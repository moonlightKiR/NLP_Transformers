...
Para ello, el trabajo se estructura en torno a la implementación y el ajuste fino (\textit{fine-tuning}) de dos arquitecturas de Transformers ejecutables en hardware local: \textbf{Qwen 3.5-2B} y \textbf{Llama 3.2-1B-Instruct}. El núcleo del estudio consiste en realizar una evaluación comparativa y un análisis crítico que abarque desde la optimización de hiperparámetros (como tasas de aprendizaje y estrategias de regularización) hasta el uso de métricas avanzadas de evaluación, incluyendo el uso de modelos de lenguaje de gran escala (LLMs) como jueces de calidad.
